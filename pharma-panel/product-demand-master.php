<?php
	...
	//error_reporting(0);
	$pageName = "Custom Product Orders";
	$pageURL = 'product-demand-master.php';
	$addURL = 'product-demand-add.php';
	$deleteURL = 'product-demand-master.php';
	$tableName = 'demand_product';
