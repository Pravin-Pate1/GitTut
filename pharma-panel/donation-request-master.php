<?php
	...
	//error_reporting(0);
	$pageName = "Donation Request";
	$pageURL = 'donation-request-master.php';
	$addURL = 'donation-request-add.php';
	$deleteURL = 'donation-request-master.php';
...
?>
							<tr>
								<td><?php echo $x++; ?></td>
								<td><span class="badge badge-info"><?php echo $row['request_type']; ?></span></td>
								<td><span class="badge badge-info"><?php echo $row['donation_type']; ?></span></td>
								<td><?php echo $row['full_name']; ?></td>
								<td><?php echo $row['contact']; ?></td>
								<td><?php echo $row['email']; ?></td>
								<td><?php echo nl2br($row['full_address']); ?></td>
